...
<div>
  <b-row>
    <b-colxx xxs="12">
      <piaf-breadcrumb :heading="$t('menu.bulletin')"/>
      <div class="separator mb-5"></div>
    </b-colxx>
  </b-row>
   <div class="m-3 d-flex" style="overflow-x: auto;">
      <img src="/bulletin/report.svg" class="m-3" alt="bulletin">
      <img src="/bulletin/report.svg" class="m-3" alt="bulletin">
      <img src="/bulletin/report.svg" class="m-3" alt="bulletin">
      <img src="/bulletin/report.svg" class="m-3" alt="bulletin">
      <img src="/bulletin/report.svg" class="m-3" alt="bulletin">
          ...
          <b-row class="h-100" align-v="center" align-h="end">
            <b-colxx md="3">
              <b-button
                ...
                v-b-modal.generate-modal
                :disabled="rowsSelect === 0"
                >
                Génerer
              </b-button>
            </b-colxx>
  ...
  <b-modal @ok="$router.push('../generated/' + $route.params.level)" id="generate-modal" title="Génération de bulletins" ok-only>
    <p>Tous les bulletins sélèctionnés ont bien été générés</p>
